...
const CustomerWallet = () => {
  ...
  return (
    ...
    >
      ...
      <section className="flex flex-col gap-4 mt-5 px-5">
        ...
        {transactions.data?.data?.map((transaction) => (
          ...
          >
              ...
              <div className="flex flex-col gap-[6px]">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm text-premiere-green">
                    + {rupiahFormat(transaction.price)}
                  </p>
                </div>
              </div>
            </div>
            <p
              className={cn(
                `w-fit rounded-full p-[8px_10px] font-semibold text-[15px] leading-[15px]`,
                transaction.status === "failed" && "bg-red-300 text-red-500",
      ...
      <BottomBar activeLink="wallet"></BottomBar>
    </div>
  );
};
